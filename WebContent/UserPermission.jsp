...
function validateForm() {
 ...
 if(document.forms["frmUserPermission"]["UserID"].selectedIndex == "0"){
	 alert("Select User");
	 return false;
 }	

 if(document.forms["frmUserPermission"]["readPermission"].checked ==false && 
		 document.forms["frmUserPermission"]["writePermission"].checked==false){
...
<form action="UserPermission" name="frmUserPermission" method="post" onsubmit="return validateForm()">
<table>
<tr>
<th>Select User</th>
...
<td rowspan="2">
<input type="checkbox" name="readPermission" id="readPermission" value="Read">Read<br>
<input type="checkbox" name="writePermission" id="writePermission" value="Write">Write
</td>
</tr><tr></tr>
